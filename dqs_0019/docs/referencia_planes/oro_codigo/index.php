        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-box">
                        <h2>Eventos</h2>
                        <p>Estamos muy felices y queremos compartir este día con vos!<br>Te dejamos toda la información de nuestro casamiento, para que nos acompañes en este gran día!</p>
                    </div>
                </div>
            </div>
            <div class="row">
