...
$eventos_text_fields = [
    'eventos_section_header_visible' => ['type' => 'visible', 'label' => 'Mostrar título y bajada de la sección'],
    'eventos_section_title' => ['type' => 'text', 'label' => 'Título de sección'],
    'eventos_section_subtitle' => ['type' => 'textarea', 'label' => 'Bajada / descripción'],
];
dqs_admin_save_section_text($conn, 'eventos', $eventos_text_fields, $mensaje, $error);

if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['eventos']) && is_array($_POST['eventos'])) {
...
<body>
    ...
    <?php dqs_admin_render_section_text('eventos', 'Texto de la sección Eventos', $eventos_text_fields, dqs_get_plan_config($conn)); ?>
