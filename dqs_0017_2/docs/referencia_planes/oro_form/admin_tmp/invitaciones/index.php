...
(
 ...
 FROM pre_invitados_listado_mesa aa -- MODIFICADO
 INNER JOIN (
 SELECT id_invitados
 ...
 FROM pre_invitados_listado_mesa -- MODIFICADO
 GROUP BY id_invitados
 ) bb
 ON aa.id_invitados = bb.id_invitados
 WHERE 1=1
) a
INNER JOIN pre_invitados b -- MODIFICADO
...
FROM 
 pre_invitados_tel a -- MODIFICADO
GROUP BY 
 id_invitados
) f
