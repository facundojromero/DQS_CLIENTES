...
$mas_info_text_fields = [
    'mas_info_section_header_visible' => ['type' => 'visible', 'label' => 'Mostrar título y bajada de la sección'],
    'mas_info_section_title' => ['type' => 'text', 'label' => 'Título de sección'],
    'mas_info_section_subtitle' => ['type' => 'textarea', 'label' => 'Bajada / descripción'],
];
dqs_admin_save_section_text($conn, 'mas_info', $mas_info_text_fields, $mensaje, $error);

if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['info_otra']) && is_array($_POST['info_otra'])) {
...
<body>
    ...
    <?php dqs_admin_render_section_text('mas_info', 'Texto de la sección Más Info', $mas_info_text_fields, dqs_get_plan_config($conn)); ?>
