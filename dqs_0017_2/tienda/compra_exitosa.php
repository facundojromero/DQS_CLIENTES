...
dqs_require_gifts_enabled($conn, 'html');
...
<body id="tienda" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
    ...
    <?php
    $configLinkRegalar = obtenerDestinoLinkRegalar($conn, true);
                ...
                <div class="row">
                    <div class="lbox-caption2">
                        <div class="lbox-details2">
                            ...
                            <a href="<?= htmlspecialchars($regalosLinkHref) ?>" class="btn">Regalar</a>
                            <?php endif; ?>
    ...
    <div class="checkout-container">
        ...
        <div>
            <?php if ($mostrarLinkRegalar): ?>
            <?php $seguirRegalandoHref = !empty($configLinkRegalar['mostrar_lista_regalos']) ? './?currency=' . urlencode($moneda) : $regalosLinkHref; ?>
            <a href="<?php echo htmlspecialchars($seguirRegalandoHref); ?>" class="button"><i class="fas fa-shopping-cart"></i> Seguir Regalando</a>
            <?php endif; ?>
        </div>
    </div>
