        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-box">
                        <h2>Eventos</h2>
                        <p>Estamos emocionados de compartir estos eventos significativos con nuestros seres queridos. Cada momento es un paso más en nuestra historia de amor.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                if ($result_confirmar > 0) {
                    while ($data = mysqli_fetch_array($query)) {
                        if ($data["confirmacion"] == "Si") {
                            echo "<div style='text-align: center;'>Ya está confirmado
                            <br>Invitados: " . $data["invitados"] . "
                            <br>Mayores: " . $data["confirmacion_mayores"] . "
                            <br>Menores: " . $data["confirmacion_menores"] . "
                            </div>";
                        } else {
