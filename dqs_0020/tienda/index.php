...
if ($mostrarListaRegalos && $mostrar_moneda): 
?>
    <div class="pagination">
...
<?php endif; ?>
    ...
    <?php if (!$mostrarListaRegalos): ?>
    <div class="container" style="max-width: 760px; margin: 30px auto; text-align:center;">
        <p>La lista de regalos no está disponible en este momento.</p>
        <?php if ($mostrarTransferenciaRegalos): ?>
            <p>Podés ver los datos para transferir en la sección Más Info.</p>
        <?php endif; ?>
    </div>
    <?php endif; ?>
