...
<div class="modal-body">
    ...
    <form id="formConfirmacion" action="procesar_confirmacion.php" method="POST">
        ...
        <div id="campos-asistencia" style="display: none;">
            ...
            <label for="comentario_adicional">Si queres podes dejarnos algún mensaje:</label>
            <textarea class="form-control" id="comentario_adicional" name="confirmacion_comentario2" rows="3"></textarea>
        </div>
...
<script>
    $(document).ready(function() {
        ...
        function generarCamposAcompanantes() {
            ...
            if (cantMayores > 1) {
                contenedor.append('<h6 class="text-primary mt-2">Acompañante</h6>');
