...
// Los guards de rutas se ejecutan antes de consultar datos operativos.
$requested_page = $_GET['new'] ?? '';
if ($requested_page === 'envioinvitaciones') {
    dqs_require_admin_whatsapp_enabled($conn);
}
if ($requested_page === 'contactos_envio') {
    dqs_require_admin_contactos_envio($conn);
}
if ($requested_page === 'invitaciones') {
    dqs_disable_legacy_whatsapp_endpoint();
}
...
<?php
// Contactos staging usados exclusivamente para envíos en Oro + FORM.
if (isset($_GET['new']) && $_GET['new'] == 'contactos_envio'): ?>
    <div class="container">
        <?php include 'contactos_envio.php'; ?>
    </div>
<?php endif; ?>

<?php if (isset($_GET['new']) && $_GET['new'] == 'contacto'): ?>
    <div class="container">
        <?php include 'info_contacto.php'; ?>
    </div>
<?php endif; ?>
...
<?php
//CONFIGURACIÓN RSVP
if (isset($_GET['new']) && $_GET['new'] == 'rsvp_config'): ?>
    <div class="container">
        <?php include 'rsvp_config.php'; ?>
    </div>
<?php endif; ?>
